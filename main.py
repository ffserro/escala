...
if mes != 0:
    ...
    nm_ver = list(reversed(div_serv.values()))[list(reversed(div_serv.values())).index(v_1):] + 2 * list(reversed(div_serv.values())) 
    nm_pre = list(div_serv.values())[list(div_serv.values()).index(p_1):] + 2 * list(div_serv.values()) 
